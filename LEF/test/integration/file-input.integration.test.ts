...
describe("File Input Integration Tests", () => {
  let app: App;
  ...
  test("SinglePipeline MediaLive File Input", () => {
    const testDescriptor = "File_SinglePipeline_MediaLive";
    ...
    new IntegTest(app, "Test_File_SinglePipeline_MediaLive", {
      testCases: [lefStack],
      cdkCommandOptions: {
        deploy: {
          args: {
  ...
  test("Standard MediaLive File Input", () => {
    const testDescriptor = "File_Standard_MediaLive";
    ...
    new IntegTest(app, "Test_File_Standard_MediaLive", {
      testCases: [lefStack],
      cdkCommandOptions: {
        deploy: {
          args: {
  ...
  test("SinglePipeline MediaLiveAnywhere File Input", () => {
    const testDescriptor = "File_SinglePipeline_MediaLiveAnywhere";
    ...
    new IntegTest(app, "Test_File_SinglePipeline_MediaLiveAnywhere", {
      testCases: [lefStack],
      cdkCommandOptions: {
        deploy: {
          args: {
  ...
  test("Standard MediaLiveAnywhere File Input should fail", () => {
    const testDescriptor = "File_Standard_MediaLiveAnywhere";
    ...
    expect(() => {
      ...
      new IntegTest(app, "Test_File_Standard_MediaLiveAnywhere", {
        testCases: [lefStack],
        cdkCommandOptions: {
          deploy: {
            args: {
