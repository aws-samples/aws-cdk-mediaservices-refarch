...
describe("LEF Event Stack", () => {
  describe("MediaLive Input Configurations - URL Pull Inputs", () => {
    let app: App;
    ...
    describe("Single Pipeline MediaLive Channel", () => {
      ...
      const testDescriptor2 = `${testDescriptor1}_${encoderType}_${channelClass}_UrlPullInput`;
      let testConfig;
      ...
      it("should create a url pull input with correct settings", () => {
        template.hasResourceProperties("AWS::MediaLive::Input", {
          Type: "URL_PULL",
          Sources: [
            {
              Url: singlePipelineUrlPullInput.urls[0].url,
              Username: singlePipelineUrlPullInput.urls[0].username,
              PasswordParam: singlePipelineUrlPullInput.urls[0].password,
            },
          ],
        });
      });
    ...
    describe("Standard MediaLive Channel", () => {
      ...
      it("should create a url pull input with correct settings", () => {
        template.hasResourceProperties("AWS::MediaLive::Input", {
          ...
          Sources: [
            {
              Url: standardChannelUrlPullInput.urls[0].url,
              Username: standardChannelUrlPullInput.urls[0].username,
              PasswordParam: standardChannelUrlPullInput.urls[0].password,
            },
            {
              Url: standardChannelUrlPullInput.urls[1].url,
              Username: standardChannelUrlPullInput.urls[1].username,
              PasswordParam: standardChannelUrlPullInput.urls[1].password,
            },
          ],
        });
      });
