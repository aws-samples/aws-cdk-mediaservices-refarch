...
describe("LEF Event Stack", () => {
  describe("MediaLive Input Configurations - MediaConnect Inputs", () => {
    let app: App;
    ...
    describe("Single Pipeline MediaLive Channel", () => {
      ...
      const testDescriptor2 = `${testDescriptor1}_${encoderType}_${channelClass}_MediaConnectInput`;
      let testConfig;
      ...
      beforeEach(() => {
        ...
        testConfig = new TestConfigBuilder(ConfigService.defaultConfig)
          ...
          .withInput(singlePipelineMediaConnectInput)
      ...
      it("should create a mediaconnect input with correct settings", () => {
        template.hasResourceProperties("AWS::MediaLive::Input", {
          Name: Match.anyValue(),
          Type: "MEDIACONNECT",
          MediaConnectFlows: [
            {
              FlowArn: singlePipelineMediaConnectInput.arnList[0],
            },
          ],
    ...
    describe("Standard MediaLive Channel", () => {
      ...
      beforeEach(() => {
        ...
        testConfig = new TestConfigBuilder(ConfigService.defaultConfig)
          .withChannelClass(channelClass)
          .withInput(standardChannelMediaConnectInput)
          .writeConfig(testDescriptor2);
      ...
      it("should create a mediaconnect input with correct settings", () => {
        template.hasResourceProperties("AWS::MediaLive::Input", {
          ...
          Type: "MEDIACONNECT",
          MediaConnectFlows: [
            { FlowArn: standardChannelMediaConnectInput.arnList[0] },
            { FlowArn: standardChannelMediaConnectInput.arnList[1] },
          ],
          RoleArn: Match.objectLike({
            "Fn::ImportValue": Match.anyValue(),
          }),
