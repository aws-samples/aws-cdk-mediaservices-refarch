...
describe("LEF Event Stack", () => {
  describe("MediaLive Input Configurations - File Inputs", () => {
    let app: App;
    ...
    describe("Single Pipeline MediaLive Channel", () => {
      ...
      const testDescriptor2 = `${testDescriptor1}_${encoderType}_${channelClass}_FileInput`;
      let testConfig;
      ...
      it("should create a file input with correct settings", () => {
        template.hasResourceProperties("AWS::MediaLive::Input", {
          Name: Match.anyValue(),
          Type: "MP4_FILE",
          Sources: [
            {
              Url: singlePipelineFileInput.urls[0],
            },
          ],
        });
      });
    ...
    describe("Standard MediaLive Channel", () => {
      ...
      it("should create a file input with correct settings", () => {
        template.hasResourceProperties("AWS::MediaLive::Input", {
          ...
          Type: "TS_FILE",
          Sources: [
            { Url: standardChannelFileInput.urls[0] },
            { Url: standardChannelFileInput.urls[1] },
          ],
        });
      });
    });
